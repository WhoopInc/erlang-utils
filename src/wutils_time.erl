...
parse_iso_test_() ->
    ...
    ,?_assertEqual({{2015,1,1},{5,0,0.0}},      parse_iso(<<"2015-01-01T00:00:00-0500">>))
    ,?_assertEqual({{2015,1,1},{5,0,0.123}},    parse_iso(<<"2015-01-01T00:00:00.123456789-0500">>))
    ,?_assertEqual({{2014,1,1},{5,0,0.0}},      parse_iso(<<"2014-01-01T00:00:00.000-05:00">>))
    ,?_assertEqual({{2016,8,2},{15,35,0.0}},    parse_iso(<<"2016-08-02T15:35:00.000Z">>))
    ].
